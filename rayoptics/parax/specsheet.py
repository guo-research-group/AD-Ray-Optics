...
"""
#import math
from jax.numpy import inf, tan, radians
from jax.lax import asin
...
def create_specsheet(conjugate_type, **inputs):
    if conjugate_type == 'finite':
        ...
        imager_inputs = {'s': -inf}
        imager = IdealImager(None, -inf, None, None, None)
